            ...
            <div className="menuLateral">
                <div className="bg-azul justify-start items-start inline-flex pb-[45.3%]">
                    <div className="flex relative top-24 left-16">
                        <Image src={"/../public/Ellipse4.png"} width={70} height={70} alt=""/>
                    ...
                    <div>
                        <div className="relative right-[150px] top-[300px] pb-10">
                            <Link href='/../../pages/dashboard' className="gap-2 flex flex-row">                                
                                <Image src={"/../public/icons/Home.png"} width={40} height={40} alt=""/>
                                <h3 className="pt-2 font-semibold text-lg">Dashboard</h3>                                                                          
                            </Link>
                        </div>
                        <div className="relative right-[150px] top-[300px] pb-10">
                        ...
                        <div className="relative right-[150px] top-[300px] pb-10">
                            <Link className="gap-2 flex flex-row" href="/../../pages/calendario">
                                ...
                                <h3 className="pt-2 font-semibold text-lg">Calendário</h3>
                            </Link>
                        </div>
